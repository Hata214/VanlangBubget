...
export default function AddTransactionDialog({
    ...
    useEffect(() => {
        if (autoCalculateFee && price && quantity) {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            // Chuyển đổi date từ Date sang string
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <FormControl>
                                                <Input
                                                    type="number"
                                                    {...field}
                                                    disabled={isLoading || autoCalculateFee}
                                                    className={autoCalculateFee ? "bg-muted max-w-32" : "max-w-32"}
                                                />
                                            </FormControl>
                                        </div>
                                        <FormMessage />
